[index (19).html](https://github.com/user-attachments/files/22680456/index.19.html)
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
...
<body class="antialiased">
    ...
    <script>
        ...
        let player; 
        let videoDuration = 0;
        const HUGGING_FACE_API_KEY = "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"; // API Key diperbarui di sini
